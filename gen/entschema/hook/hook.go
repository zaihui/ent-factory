...
type TestFunc func(context.Context, *entschema.TestMutation) (entschema.Value, error)

// Mutate calls f(ctx, m).
func (f TestFunc) Mutate(ctx context.Context, m entschema.Mutation) (entschema.Value, error) {
	mv, ok := m.(*entschema.TestMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entschema.TestMutation", m)
	}
	return f(ctx, mv)
}
